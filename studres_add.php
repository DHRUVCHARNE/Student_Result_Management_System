...
//to the execution file st_res_add.php
session_start();
include("header.inc");
  ...
  <div class="container-lg">
    <div class="row">
      <div class="mx-auto col-10 col-md-8 col-lg-6">
        <form class="card p-4 bg-light" action="st_res_add.php" method="post">
          ...
          <div class="form-group row">
            ...
            <input type="text" name="course" class="form-control" id="exampleInputEmail1" placeholder="Course Name"
              required>
          </div>
          <div class="form-group row">
            <label style="padding: 16px;" for="exampleInputEmail1" class="form-label">Obtained Marks</label>
            <input type="number" name="ObtMarks" class="form-control" id="exampleInputEmail1"
              placeholder="Obtained Marks" required>
          </div>
          <div class="form-group row">
            <label style="padding: 16px;" for="exampleInputEmail1" class="form-label">Maximum Marks</label>
            <input type="number" name="MaxMarks" class="form-control" id="exampleInputEmail1"
